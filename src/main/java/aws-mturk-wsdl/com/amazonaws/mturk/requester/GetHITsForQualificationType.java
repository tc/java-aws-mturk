/**
 * GetHITsForQualificationType.java
 *
...
public class GetHITsForQualificationType  implements java.io.Serializable {
    ...
    private com.amazonaws.mturk.requester.GetHITsForQualificationTypeRequest[] request;
    ...
    public GetHITsForQualificationType(
           ...
           com.amazonaws.mturk.requester.GetHITsForQualificationTypeRequest[] request) {
     ...
     * @return request
     */
    public com.amazonaws.mturk.requester.GetHITsForQualificationTypeRequest[] getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(com.amazonaws.mturk.requester.GetHITsForQualificationTypeRequest[] request) {
        this.request = request;
    }

    public com.amazonaws.mturk.requester.GetHITsForQualificationTypeRequest getRequest(int i) {
        return this.request[i];
    }

    public void setRequest(int i, com.amazonaws.mturk.requester.GetHITsForQualificationTypeRequest _value) {
        this.request[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetHITsForQualificationType)) return false;
        GetHITsForQualificationType other = (GetHITsForQualificationType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetHITsForQualificationType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://requester.mturk.amazonaws.com/doc/2007-06-21", ">GetHITsForQualificationType"));
