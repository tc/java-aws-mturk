...
public class ApproveAssignment  implements java.io.Serializable {
    ...
    private com.amazonaws.mturk.requester.ApproveAssignmentRequest[] request;
    ...
    public ApproveAssignment(
           ...
           com.amazonaws.mturk.requester.ApproveAssignmentRequest[] request) {
    ...
    /**
     * Gets the AWSAccessKeyId value for this ApproveAssignment.
     * 
    ...
    /**
     * Sets the AWSAccessKeyId value for this ApproveAssignment.
     * 
    ...
    /**
     * Gets the timestamp value for this ApproveAssignment.
     * 
     * @return timestamp
     */
    ...
    /**
     * Sets the timestamp value for this ApproveAssignment.
     * 
     * @param timestamp
     */
    ...
    /**
     * Gets the signature value for this ApproveAssignment.
     * 
     * @return signature
     */
    ...
    /**
     * Sets the signature value for this ApproveAssignment.
     * 
     * @param signature
     */
    ...
    /**
     * Gets the validate value for this ApproveAssignment.
     * 
     * @return validate
     */
    ...
    /**
     * Sets the validate value for this ApproveAssignment.
     * 
     * @param validate
     */
    ...
    /**
     * Gets the credential value for this ApproveAssignment.
     * 
     * @return credential
     */
    ...
    /**
     * Sets the credential value for this ApproveAssignment.
     * 
     * @param credential
     */
    ...
    /**
     * Gets the request value for this ApproveAssignment.
     * 
     * @return request
     */
    public com.amazonaws.mturk.requester.ApproveAssignmentRequest[] getRequest() {
        return request;
    }


    /**
     * Sets the request value for this ApproveAssignment.
     * 
     * @param request
     */
    public void setRequest(com.amazonaws.mturk.requester.ApproveAssignmentRequest[] request) {
        this.request = request;
    }

    public com.amazonaws.mturk.requester.ApproveAssignmentRequest getRequest(int i) {
        return this.request[i];
    }

    public void setRequest(int i, com.amazonaws.mturk.requester.ApproveAssignmentRequest _value) {
        this.request[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ApproveAssignment)) return false;
        ApproveAssignment other = (ApproveAssignment) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ApproveAssignment.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://requester.mturk.amazonaws.com/doc/2007-06-21", ">ApproveAssignment"));
