...
public class GetQualificationScore  implements java.io.Serializable {
    ...
    private com.amazonaws.mturk.requester.GetQualificationScoreRequest[] request;
    ...
    public GetQualificationScore(
           ...
           com.amazonaws.mturk.requester.GetQualificationScoreRequest[] request) {
    ...
    /**
     * Gets the AWSAccessKeyId value for this GetQualificationScore.
     * 
    ...
    /**
     * Sets the AWSAccessKeyId value for this GetQualificationScore.
     * 
    ...
    /**
     * Gets the timestamp value for this GetQualificationScore.
     * 
     * @return timestamp
     */
    ...
    /**
     * Sets the timestamp value for this GetQualificationScore.
     * 
     * @param timestamp
     */
    ...
    /**
     * Gets the signature value for this GetQualificationScore.
     * 
     * @return signature
     */
    ...
    /**
     * Sets the signature value for this GetQualificationScore.
     * 
     * @param signature
     */
    ...
    /**
     * Gets the validate value for this GetQualificationScore.
     * 
     * @return validate
     */
    ...
    /**
     * Sets the validate value for this GetQualificationScore.
     * 
     * @param validate
     */
    ...
    /**
     * Gets the credential value for this GetQualificationScore.
     * 
     * @return credential
     */
    ...
    /**
     * Sets the credential value for this GetQualificationScore.
     * 
     * @param credential
     */
    ...
    /**
     * Gets the request value for this GetQualificationScore.
     * 
     * @return request
     */
    public com.amazonaws.mturk.requester.GetQualificationScoreRequest[] getRequest() {
        return request;
    }


    /**
     * Sets the request value for this GetQualificationScore.
     * 
     * @param request
     */
    public void setRequest(com.amazonaws.mturk.requester.GetQualificationScoreRequest[] request) {
        this.request = request;
    }

    public com.amazonaws.mturk.requester.GetQualificationScoreRequest getRequest(int i) {
        return this.request[i];
    }

    public void setRequest(int i, com.amazonaws.mturk.requester.GetQualificationScoreRequest _value) {
        this.request[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetQualificationScore)) return false;
        GetQualificationScore other = (GetQualificationScore) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetQualificationScore.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://requester.mturk.amazonaws.com/doc/2007-06-21", ">GetQualificationScore"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://requester.mturk.amazonaws.com/doc/2007-06-21", "GetQualificationScoreRequest"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
