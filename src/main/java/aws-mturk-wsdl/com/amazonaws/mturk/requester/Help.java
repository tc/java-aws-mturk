...
public class Help  implements java.io.Serializable {
    ...
    private com.amazonaws.mturk.requester.HelpRequest[] request;
    ...
    public Help(
           ...
           com.amazonaws.mturk.requester.HelpRequest[] request) {
    ...
    /**
     * Gets the timestamp value for this Help.
     * 
     * @return timestamp
     */
    ...
    /**
     * Sets the timestamp value for this Help.
     * 
     * @param timestamp
     */
    ...
    /**
     * Gets the signature value for this Help.
     * 
     * @return signature
     */
    ...
    /**
     * Sets the signature value for this Help.
     * 
     * @param signature
     */
     ...
     * @return request
     */
    public com.amazonaws.mturk.requester.HelpRequest[] getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(com.amazonaws.mturk.requester.HelpRequest[] request) {
        this.request = request;
    }

    public com.amazonaws.mturk.requester.HelpRequest getRequest(int i) {
        return this.request[i];
    }

    public void setRequest(int i, com.amazonaws.mturk.requester.HelpRequest _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://requester.mturk.amazonaws.com/doc/2007-06-21", ">Help"));
