/**
 * GetWorkerAcceptLimitResult.java
 *
...
public class GetWorkerAcceptLimitResult  implements java.io.Serializable {
    private int maxWorkerAcceptLimit;

    private com.amazonaws.mturk.requester.Request request;

    public GetWorkerAcceptLimitResult() {
    }
    ...
    /**
     * Gets the maxWorkerAcceptLimit value for this GetWorkerAcceptLimitResult.
     * 
    ...
    /**
     * Sets the maxWorkerAcceptLimit value for this GetWorkerAcceptLimitResult.
     * 
    ...
    /**
     * Gets the request value for this GetWorkerAcceptLimitResult.
     * 
     * @return request
     */
    ...
    /**
     * Sets the request value for this GetWorkerAcceptLimitResult.
     * 
     * @param request
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetWorkerAcceptLimitResult)) return false;
        GetWorkerAcceptLimitResult other = (GetWorkerAcceptLimitResult) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetWorkerAcceptLimitResult.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://requester.mturk.amazonaws.com/doc/2007-06-21", "GetWorkerAcceptLimitResult"));
